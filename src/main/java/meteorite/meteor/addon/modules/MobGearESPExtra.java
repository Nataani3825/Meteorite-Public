 ...
 * SpawnerScout
 * =======
 *  - Skidded from Trouser MobGearESP
 *  - Originally written by Windoid
 *  - Modified by Nataani
...
public class MobGearESPExtra extends Module {
    ...
    public MobGearESPExtra() {
        super(Meteorite.Main, "MobGearESPExtra", "ESP Module that highlights mobs likely wearing player gear. Skidded from TrouserStreak to include logging/waypoints");
    }
